...
namespace Facturacion
{
    public partial class frmVentas : Form
    {
        ...
        //    // Encabezado
        //    e.Graphics.DrawImage(imageList1.Images[0], 50, yPos, 100, 100); // Imagen izquierda
        //    e.Graphics.DrawImage(imageList1.Images[0], 650, yPos, 100, 100); // Imagen derecha

        //    // Encabezado
        //    yPos += 40;
        //    e.Graphics.DrawString("TIENDA VM", fuenteTitulo, Brushes.Black, new RectangleF(300, yPos, 300, 40));
        //    yPos += 40;
        //    e.Graphics.DrawString("FECHA: " + hoy.ToString("dd/MM/yyyy"), fuenteSubtitulo, Brushes.Black, new RectangleF(50, yPos, 300, 20));
        //    e.Graphics.DrawString("ID VENTA: " + maxid, fuenteSubtitulo, Brushes.Black, new RectangleF(500, yPos, 300, 20));
        //    yPos += 30;
        ...
        //    e.Graphics.DrawString("Precio Unitario", fuenteSubtitulo, Brushes.Black, new RectangleF(350, yPos, 100, 20));
        ...
        //        e.Graphics.DrawString(detalle.IVA.ToString("P"), fuenteContenido, Brushes.Black, new RectangleF(550, yPos, 100, 20));
